...
//         - 3 valeurs (stockés dans un Vec3f euler_angles) correspondant aux angles de rotations sur les 3 axes.
...
Vec3f inclinaison(vector<Point2f> modele, vector<Point2f> objet, Mat rot_mat, Mat trans_mat, Vec3f euler_angles){
