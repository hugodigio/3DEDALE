...
/** Pensez a faire :
 ...
 Voir si on peut faire un axe qui fait moins "attacher" au plan
 ...
 Definir la vitesse a partir de l'angle de Rotation du plateau
 Definir a partir de quel angle la boule ne bougera plus (plus de 90 la boule
